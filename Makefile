...
_download_all_logs:
	discovery-infra/download_logs.py $(REMOTE_SERVICE_URL) $(LOGS_DEST)  --download-all  $(ADDITIONAL_PARAMS)

download_all_logs:
	skipper make $(SKIPPER_PARAMS) _download_all_logs ADDITIONAL_PARAMS="'--download-all --must-gather  ${ADDITIONAL_PARAMS}'"
